...
KEYWORD_RULES = [
    ...
    (["과기부"], "#과기부", "ministry"),
    (["중기부"], "#중기부", "ministry"),
    (["NIPA", "정보화진흥원"], "#NIPA", "ministry"),
    (["KIAT", "산업기술진흥원"], "#KIAT", "ministry"),
    (["KETEP", "에너지기술평가원"], "#KETEP", "ministry"),
    (["기술개발"], "#기술개발", "biztype"),
    (["실증"], "#실증", "biztype"),
    (["보급", "확산"], "#보급확산", "biztype"),
    (["컨소시엄"], "#컨소시엄", "biztype"),
    ...
    (["피지컬"], "#피지컬AI", "domain"),
    (["자율제조", "자율"], "#자율제조", "domain"),
    (["디지털전환", "DX"], "#디지털전환", "domain"),
    (["신재생", "재생에너지", "태양광", "풍력"], "#신재생에너지", "domain"),
    (["ESG", "탄소중립", "탄소"], "#ESG탄소중립", "domain"),
    (["수소"], "#수소", "domain"),
    (["배터리", "이차전지"], "#배터리", "domain"),
    (["로봇", "협동로봇"], "#로봇", "domain"),
    (["비전검사", "머신비전"], "#비전검사", "domain"),
    (["예지보전", "예측"], "#예지보전", "domain"),
    (["디지털트윈"], "#디지털트윈", "domain"),
    (["공급망", "SCM"], "#공급망", "domain"),
]
