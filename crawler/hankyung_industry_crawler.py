...
한경엔 "AI"·"철강" 전용 섹션이 없어(관련 기사가 여러 섹션에 흩어져 나옴)
섹션 라벨을 그대로 쓰지 않고, 기사 제목에 common.classify_news_domain()
을 적용해 철강/AI/반도체·전자/모빌리티·자동차/소재·에너지/석유화학 6개
도메인 중 하나로 재분류한다(매칭 안 되면 원 섹션의 기본 도메인으로 폴백).
